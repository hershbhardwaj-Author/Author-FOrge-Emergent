...
const BeyondTheMountainHero = () => (
  <section data-testid="section-beyond-mountain" className="relative">
    ...
    {/* Copy Section */}
    <div className="bg-[var(--ia-ivory-warm)] border-b hairline">
      <div className="max-w-[1480px] mx-auto px-6 sm:px-12 lg:px-20 py-20 sm:py-28">
        <div className="max-w-[65ch] mx-auto text-center">
          <p className="text-lg sm:text-xl text-[var(--ia-ink-mute)] italic leading-relaxed">
            You spent your life becoming someone.<br />
            Now discover who you became.
          </p>

          <div className="mt-10 w-24 mx-auto"><RuleOrnament glyph="✦" /></div>

          <div className="mt-10 space-y-6 text-lg sm:text-xl leading-relaxed text-[var(--ia-ink-soft)]">
            <p>Your achievements tell a story.</p>
            <p>But they don't necessarily tell you what the story means.</p>
            <p>
              Writing your first book makes you go back through the years — the choices, victories, failures, sacrifices, people, ideas and turning points — and make meaning from them.
            </p>
          </div>

          <div className="mt-12 space-y-4 text-lg sm:text-xl leading-relaxed text-[var(--ia-ink)]">
            <p>
              <em className="font-display-italic text-[var(--ia-forest)]">Beyond the Mountain</em> is a five-month journey for accomplished people ready to do exactly that.
            </p>
            <p className="text-[var(--ia-ink-mute)] italic">Not to become more successful.</p>
            <p className="font-display text-2xl sm:text-3xl leading-tight">
              To <em className="font-display-italic text-[var(--ia-forest)]">understand</em> the success they've already created.
            </p>
            <p className="text-[var(--ia-ink-mute)] italic">
              And from that understanding, decide what comes next.
            </p>
          </div>

          {/* Prominent text line — no button */}
          <div className="mt-14">
            <p className="font-display text-[28px] sm:text-[36px] lg:text-[44px] leading-[1.05] text-[var(--ia-ink)] tracking-[0.02em]">
              Write the next chapter.
            </p>
          </div>

          <div className="mt-10 flex items-center justify-center gap-4 text-[var(--ia-ink-mute)]">
            <span className="font-display tabular text-[11px] tracking-[0.4em] uppercase">Folio</span>
            <span className="leader-dots" />
            <span className="font-display tabular text-[11px] tracking-[0.4em] uppercase">Proem · 1 pp</span>
          </div>
        </div>
      </div>
    </div>
